...
public class KurentoRoomDemoApp extends KurentoRoomServerApp {
  ...
  private final Integer DEMO_KMS_NODE_LIMIT = PropertiesManager.getProperty("demo.kmsLimit", 5000);
  ...
  // tambahan	
	...
	public User firstUser(){
		...
		if (userRepository.findAll().isEmpty()){
			admin.setName("mangadul");
			admin.setPassword("Mt020215as2009");
			admin.setEmail("muin.abdul@gmail.com");
