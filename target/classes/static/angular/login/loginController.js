...
kurento_room.controller('loginController', function ($scope, $http, ServiceParticipant, $window, ServiceRoom, LxNotificationService) {
    ...
    $scope.register = function (room) {
        ...
        $scope.userPass = room.userPass;

		// cek user & password		
		/*
		this.postForm = function() {
		*/
			var param = {'uname':encodeURIComponent($scope.userName),'upass':encodeURIComponent($scope.userPass)};
			$http.post("/users/AuthLogin", {param}, {headers: {'Content-Type': 'application/json'} })
